...
async def async_setup_entry(
    ...
    async_add_entities([SleepMeScheduleSwitch(update_manager, client, device_info_data)])
...
class SleepMeScheduleSwitch(CoordinatorEntity, SwitchEntity):
    ...
    def __init__(self, coordinator: SleepMeUpdateManager, client: SleepMeClient, device_info_data: dict):
        ...
        self._attr_device_info = {
            "identifiers": {(DOMAIN, client.device_id)}, "name": display_name,
            "manufacturer": MANUFACTURER, "model": device_info_data.get("model"),
